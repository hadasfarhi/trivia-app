...
public class MusicQ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getPoint(point);
                numQ=-1;
                startActivity(new Intent(MusicQ.this, EndSession.class));
            }
        });
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("Questions").child("Music");
                ...
                button1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (slist.get(0) == gooda)
                        {
                            ...
                            Toast.makeText(MusicQ.this , "point " + extraPoint, Toast.LENGTH_SHORT).show();
                        }
