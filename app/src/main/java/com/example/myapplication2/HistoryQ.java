...
public class HistoryQ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getPoint(point);
                numQ=-1;
                startActivity(new Intent(HistoryQ.this, EndSession.class));
            }
        });
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("Questions").child("History");
