    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stop.setOnClickListener(new View.OnClickListener() {            //to stop the round
            ...
            public void onClick(View v) {
                ...
                numQ=-1;
                startActivity(new Intent(quesActivity.this, EndSession.class));     // go to EndSession
            }
        });
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("Questions").child(qtype);    //From which category to bring the questions
                ...
                button1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (slist.get(0) == gooda)      //Check if the answer is correct
                        {
                            ...
                            Toast.makeText(quesActivity.this , "point " + extraPoint, Toast.LENGTH_SHORT).show();    //show it on the bottom of the screen
                        }
                        ...
                        if (alist.isEmpty())        //Checks if the questions are over in the round
                        {
                            ...
                            startActivity(new Intent(quesActivity.this, EndSession.class));  //go to the EndSession
                        }
                        else {
                            setAsArrayString(alist);
                ...
                button2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (slist.get(1) == gooda) {
                            ...
                            Toast.makeText(quesActivity.this , "point " + extraPoint, Toast.LENGTH_SHORT).show();
                        }
                        ...
                        if (alist.isEmpty())
                        {
                            getPoint(point);
                            numQ--;
                            startActivity(new Intent(quesActivity.this, EndSession.class));
                        }
                        else {
                            setAsArrayString(alist);
                            qlist.add(slist.get(0));
