...
public class GeographyQ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getPoint(point);
                numQ=-1;
                startActivity(new Intent(GeographyQ.this, EndSession.class));
            }
        });
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("Questions").child("geography");
                ...
                button1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (slist.get(0) == gooda)
                        {
                            ...
                            Toast.makeText(GeographyQ.this , "point " + extraPoint, Toast.LENGTH_SHORT).show();
                        }
